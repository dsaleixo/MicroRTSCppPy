...
class PhysicalGameState {
    ...
    unordered_map< int, Unit*> unitsP1;
    unordered_map< int, Unit*> unitsR;
     ...
     */
        ...
        PhysicalGameState(const PhysicalGameState& other);
            /**
             * Creates a new game state map with the informed width and height.
...
;
         ...
         * @return
         */
         unordered_map<  int, Unit*>& getUnits(int player);
         ...
         * @return
         */
          Unit* getUnit(int ID,int player);
