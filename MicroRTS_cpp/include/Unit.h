...
class Unit {
	...
	public:
        ...
        bool operator!=(const Unit& u) const;
        Unit(int a_ID, int a_player, UnitType *a_type, int a_x, int a_y, int a_resources);
        ...
        */ 
        ...
        void getUnitAround(PhysicalGameState* pgs, Unit* &uup, Unit* &uright, Unit* &udown, Unit* &uleft);
        void getUnitAroundAux(unordered_map< int, Unit*>& units, Unit* &uup, Unit* &uright, Unit* &udown, Unit* &uleft);
